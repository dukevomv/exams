    ...
    <div class="task-list">
          ...
          <div class="col-md-12 task-choice row-margin-bottom">
            ...
            <div class="input-group col-xs-11 pull-left">
              ...
              <span class="input-group-addon">
                <label class="cursor-pointer"><input type="radio" class="choice-correct set-unique-val" name="{{$rmc_name}}" @if($choice->correct) checked @endif > Correct</label>
              </span>
            </div>
      ...
      @else
        <div class="col-md-12 task-choice row-margin-bottom">
          ...
          <div class="input-group col-xs-11 pull-left">
            <span class="input-group-addon cursor-pointer choice-handle"><i class="fa fa-arrows"></i></span>
            <input type="text" class="form-control choice-desc" placeholder="Choice">
            <span class="input-group-addon">
              <label class="cursor-pointer"><input type="radio" class="choice-correct set-unique-val" name="{{$rmc_name}}"> Correct</label>
            </span>
          </div>
          <span class="pull-right cursor-pointer trash-choice"><i class="fa fa-minus-circle"></i></span>
        </div>
      ...
      <div class="new-choice-wrap hidden">
        <div class="col-md-12 task-choice row-margin-bottom">
          ...
          <div class="input-group col-xs-11 pull-left">
            ...
            <span class="input-group-addon">
              <label class="cursor-pointer"><input type="radio" class="choice-correct set-unique-val" name="correct"> Correct</label>
            </span>
          </div>
          <span class="pull-right cursor-pointer trash-choice"><i class="fa fa-minus-circle"></i></span>
        </div>
