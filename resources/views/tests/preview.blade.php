                        ...
                        <div class="panel-body">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    ...
                                    <p><strong>Scheduled
                                            at: </strong>{{ !is_null($test->scheduled_at) ? $test->scheduled_at->format('d M, H:i') : '-'}}
                                    </p>
                                    <p><strong>Total
                                            duration: </strong>@if(!is_null($test->duration)){{$test->duration}}'@endif
                                    </p>
                                </li>
                                <li class="list-group-item">
                                ...
                                @foreach($test->users as $user)
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">
                                            <a href="{{url('/tests/'.$test->id.'/users/'.$user->id)}}" type="button"
